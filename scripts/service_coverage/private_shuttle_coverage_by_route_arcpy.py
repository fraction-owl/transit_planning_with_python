...
# are read with the engines ArcGIS Pro already bundles (xlrd for legacy
# .xls, openpyxl for .xlsx).
SHUTTLES_CSV = Path(r"Path\To\Your\private_shuttles.csv")  # the operator registry file
