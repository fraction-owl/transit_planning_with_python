...
(``scripts/modeling/prep_features_public.py`` → ``monthly_ridership_model.py``) can join onto the
...
_PLACEHOLDER_SCHOOLS_PATH = Path(r"data/schools")
