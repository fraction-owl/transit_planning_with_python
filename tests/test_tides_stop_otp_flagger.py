"""Tests for tides_stop_otp_flagger using the repo TIDES fixtures plus synthetic frames."""
...
import tides_stop_otp_flagger as target  # noqa: E402
...
def test_run_writes_tables_and_runlog(tmp_path: Path) -> None:
    ...
    runlog = tmp_path / "tides_stop_otp_flagger_runlog.txt"
